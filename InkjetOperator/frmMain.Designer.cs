...
partial class frmMain
{
    ...
    private void InitializeComponent()
    {
        ...
        pnlConnection.Margin = new Padding(4, 5, 4, 5);
        pnlConnection.Name = "pnlConnection";
        pnlConnection.Size = new Size(1429, 192);
        ...
        grpInkjet12.Location = new Point(7, 8);
        grpInkjet12.Margin = new Padding(4, 5, 4, 5);
        grpInkjet12.Name = "grpInkjet12";
        grpInkjet12.Padding = new Padding(4, 5, 4, 5);
        grpInkjet12.Size = new Size(893, 83);
        ...
        lblCom1.Location = new Point(14, 37);
        lblCom1.Margin = new Padding(4, 0, 4, 0);
        lblCom1.Name = "lblCom1";
        lblCom1.Size = new Size(103, 25);
        lblCom1.TabIndex = 0;
        ...
        cmbCom1.Location = new Point(129, 32);
        cmbCom1.Margin = new Padding(4, 5, 4, 5);
        cmbCom1.Name = "cmbCom1";
        cmbCom1.Size = new Size(127, 33);
        cmbCom1.TabIndex = 1;
        // 
        // lblCom2
        // 
        lblCom2.AutoSize = true;
        lblCom2.Location = new Point(271, 37);
        lblCom2.Margin = new Padding(4, 0, 4, 0);
        lblCom2.Name = "lblCom2";
        lblCom2.Size = new Size(103, 25);
        lblCom2.TabIndex = 2;
        ...
        cmbCom2.Location = new Point(386, 32);
        cmbCom2.Margin = new Padding(4, 5, 4, 5);
        cmbCom2.Name = "cmbCom2";
        cmbCom2.Size = new Size(127, 33);
        cmbCom2.TabIndex = 3;
        // 
        // btnConnectRs232
        // 
        btnConnectRs232.Location = new Point(529, 30);
        btnConnectRs232.Margin = new Padding(4, 5, 4, 5);
        btnConnectRs232.Name = "btnConnectRs232";
        btnConnectRs232.Size = new Size(107, 42);
        ...
        // btnDisconnectRs232
        // 
        btnDisconnectRs232.Location = new Point(643, 30);
        btnDisconnectRs232.Margin = new Padding(4, 5, 4, 5);
        btnDisconnectRs232.Name = "btnDisconnectRs232";
        btnDisconnectRs232.Size = new Size(114, 42);
        ...
        lblStatusIj1.Location = new Point(771, 37);
        lblStatusIj1.Margin = new Padding(4, 0, 4, 0);
        lblStatusIj1.Name = "lblStatusIj1";
        lblStatusIj1.Size = new Size(50, 30);
        ...
        lblStatusIj2.Location = new Point(829, 37);
        lblStatusIj2.Margin = new Padding(4, 0, 4, 0);
        lblStatusIj2.Name = "lblStatusIj2";
        lblStatusIj2.Size = new Size(50, 30);
        ...
        grpInkjet34.Location = new Point(7, 97);
        grpInkjet34.Margin = new Padding(4, 5, 4, 5);
        grpInkjet34.Name = "grpInkjet34";
        grpInkjet34.Padding = new Padding(4, 5, 4, 5);
        grpInkjet34.Size = new Size(771, 83);
        ...
        lblTcpHost.Location = new Point(14, 37);
        lblTcpHost.Margin = new Padding(4, 0, 4, 0);
        lblTcpHost.Name = "lblTcpHost";
        lblTcpHost.Size = new Size(54, 25);
        lblTcpHost.TabIndex = 0;
        lblTcpHost.Text = "Host:";
        // 
        // txtTcpHost
        // 
        txtTcpHost.Location = new Point(71, 32);
        txtTcpHost.Margin = new Padding(4, 5, 4, 5);
        txtTcpHost.Name = "txtTcpHost";
        txtTcpHost.Size = new Size(170, 31);
        ...
        lblTcpPort.Location = new Point(257, 37);
        lblTcpPort.Margin = new Padding(4, 0, 4, 0);
        lblTcpPort.Name = "lblTcpPort";
        lblTcpPort.Size = new Size(48, 25);
        lblTcpPort.TabIndex = 2;
        lblTcpPort.Text = "Port:";
        // 
        // txtTcpPort
        // 
        txtTcpPort.Location = new Point(307, 32);
        txtTcpPort.Margin = new Padding(4, 5, 4, 5);
        txtTcpPort.Name = "txtTcpPort";
        txtTcpPort.Size = new Size(84, 31);
        txtTcpPort.TabIndex = 3;
        txtTcpPort.Text = "9100";
        // 
        // btnConnectTcp
        // 
        btnConnectTcp.Location = new Point(407, 30);
        btnConnectTcp.Margin = new Padding(4, 5, 4, 5);
        btnConnectTcp.Name = "btnConnectTcp";
        btnConnectTcp.Size = new Size(107, 42);
        ...
        // btnDisconnectTcp
        // 
        btnDisconnectTcp.Location = new Point(521, 30);
        btnDisconnectTcp.Margin = new Padding(4, 5, 4, 5);
        btnDisconnectTcp.Name = "btnDisconnectTcp";
        btnDisconnectTcp.Size = new Size(114, 42);
        ...
        lblStatusIj3.Location = new Point(650, 37);
        lblStatusIj3.Margin = new Padding(4, 0, 4, 0);
        lblStatusIj3.Name = "lblStatusIj3";
        lblStatusIj3.Size = new Size(50, 30);
        ...
        lblStatusIj4.Location = new Point(707, 37);
        lblStatusIj4.Margin = new Padding(4, 0, 4, 0);
        lblStatusIj4.Name = "lblStatusIj4";
        lblStatusIj4.Size = new Size(50, 30);
        ...
        grpBackend.Location = new Point(786, 97);
        grpBackend.Margin = new Padding(4, 5, 4, 5);
        grpBackend.Name = "grpBackend";
        grpBackend.Padding = new Padding(4, 5, 4, 5);
        grpBackend.Size = new Size(529, 83);
        ...
        lblApiUrl.Location = new Point(14, 37);
        lblApiUrl.Margin = new Padding(4, 0, 4, 0);
        lblApiUrl.Name = "lblApiUrl";
        lblApiUrl.Size = new Size(43, 25);
        lblApiUrl.TabIndex = 0;
        lblApiUrl.Text = "API:";
        // 
        // txtApiUrl
        // 
        txtApiUrl.Location = new Point(57, 32);
        txtApiUrl.Margin = new Padding(4, 5, 4, 5);
        txtApiUrl.Name = "txtApiUrl";
        txtApiUrl.Size = new Size(284, 31);
        txtApiUrl.TabIndex = 1;
        txtApiUrl.Text = "http://localhost:3000";
        // 
        // btnApplyApi
        // 
        btnApplyApi.Location = new Point(350, 30);
        btnApplyApi.Margin = new Padding(4, 5, 4, 5);
        btnApplyApi.Name = "btnApplyApi";
        btnApplyApi.Size = new Size(79, 42);
        ...
        lblApiStatus.Location = new Point(443, 37);
        lblApiStatus.Margin = new Padding(4, 0, 4, 0);
        lblApiStatus.Name = "lblApiStatus";
        lblApiStatus.Size = new Size(33, 25);
        ...
        pnlJobs.Location = new Point(0, 192);
        pnlJobs.Margin = new Padding(4, 5, 4, 5);
        pnlJobs.Name = "pnlJobs";
        pnlJobs.Padding = new Padding(7, 8, 7, 8);
        pnlJobs.Size = new Size(500, 658);
        pnlJobs.TabIndex = 1;
        // 
        // dgvJobs
        // 
        ...
        dgvJobs.Location = new Point(7, 50);
        ...
        btnRefresh.Location = new Point(7, 600);
        btnRefresh.Margin = new Padding(4, 5, 4, 5);
        btnRefresh.Name = "btnRefresh";
        btnRefresh.Size = new Size(486, 50);
        ...
        pnlDetail.Location = new Point(500, 192);
        pnlDetail.Margin = new Padding(4, 5, 4, 5);
        pnlDetail.Name = "pnlDetail";
        pnlDetail.Padding = new Padding(7, 8, 7, 8);
        pnlDetail.Size = new Size(929, 658);
        ...
        lblDetailTitle.Location = new Point(7, 8);
        lblDetailTitle.Margin = new Padding(4, 0, 4, 0);
        lblDetailTitle.Name = "lblDetailTitle";
        lblDetailTitle.Size = new Size(108, 28);
        ...
        lblBarcode.Location = new Point(7, 50);
        ...
        // txtBarcode
        // 
        txtBarcode.Location = new Point(114, 45);
        txtBarcode.Margin = new Padding(4, 5, 4, 5);
        txtBarcode.Name = "txtBarcode";
        txtBarcode.ReadOnly = true;
        txtBarcode.Size = new Size(284, 31);
        txtBarcode.TabIndex = 2;
        // 
        // lblLot
        // 
        lblLot.AutoSize = true;
        lblLot.Location = new Point(414, 50);
        ...
        // txtLot
        // 
        txtLot.Location = new Point(457, 45);
        txtLot.Margin = new Padding(4, 5, 4, 5);
        txtLot.Name = "txtLot";
        txtLot.ReadOnly = true;
        txtLot.Size = new Size(213, 31);
        txtLot.TabIndex = 4;
        // 
        // lblStatus
        // 
        lblStatus.AutoSize = true;
        lblStatus.Location = new Point(686, 50);
        ...
        // txtStatus
        // 
        txtStatus.Location = new Point(757, 45);
        txtStatus.Margin = new Padding(4, 5, 4, 5);
        txtStatus.Name = "txtStatus";
        txtStatus.ReadOnly = true;
        txtStatus.Size = new Size(141, 31);
        txtStatus.TabIndex = 6;
        // 
        // lblPattern
        // 
        lblPattern.AutoSize = true;
        lblPattern.Location = new Point(7, 92);
        ...
        // txtPattern
        // 
        txtPattern.Location = new Point(114, 87);
        txtPattern.Margin = new Padding(4, 5, 4, 5);
        txtPattern.Name = "txtPattern";
        txtPattern.ReadOnly = true;
        txtPattern.Size = new Size(284, 31);
        txtPattern.TabIndex = 8;
        // 
        // grpInkjetConfigs
        // 
        grpInkjetConfigs.Controls.Add(dgvConfigs);
        grpInkjetConfigs.Location = new Point(7, 133);
        grpInkjetConfigs.Margin = new Padding(4, 5, 4, 5);
        grpInkjetConfigs.Name = "grpInkjetConfigs";
        grpInkjetConfigs.Padding = new Padding(4, 5, 4, 5);
        grpInkjetConfigs.Size = new Size(900, 217);
        ...
        dgvConfigs.ColumnHeadersHeight = 34;
        dgvConfigs.Dock = DockStyle.Fill;
        dgvConfigs.Location = new Point(4, 29);
        dgvConfigs.Margin = new Padding(4, 5, 4, 5);
        dgvConfigs.Name = "dgvConfigs";
        dgvConfigs.ReadOnly = true;
        dgvConfigs.RowHeadersWidth = 62;
        dgvConfigs.Size = new Size(892, 183);
        ...
        grpTextBlocks.Location = new Point(7, 358);
        grpTextBlocks.Margin = new Padding(4, 5, 4, 5);
        grpTextBlocks.Name = "grpTextBlocks";
        grpTextBlocks.Padding = new Padding(4, 5, 4, 5);
        grpTextBlocks.Size = new Size(900, 217);
        ...
        dgvTextBlocks.ColumnHeadersHeight = 34;
        dgvTextBlocks.Dock = DockStyle.Fill;
        dgvTextBlocks.Location = new Point(4, 29);
        dgvTextBlocks.Margin = new Padding(4, 5, 4, 5);
        dgvTextBlocks.Name = "dgvTextBlocks";
        dgvTextBlocks.ReadOnly = true;
        dgvTextBlocks.RowHeadersWidth = 62;
        dgvTextBlocks.Size = new Size(892, 183);
        ...
        btnSend.Location = new Point(7, 592);
        btnSend.Margin = new Padding(4, 5, 4, 5);
        btnSend.Name = "btnSend";
        btnSend.Size = new Size(286, 67);
        btnSend.TabIndex = 11;
        ...
        // btnRetry
        // 
        btnRetry.Location = new Point(307, 592);
        btnRetry.Margin = new Padding(4, 5, 4, 5);
        btnRetry.Name = "btnRetry";
        btnRetry.Size = new Size(171, 67);
        ...
        pnlLog.Location = new Point(0, 850);
        pnlLog.Margin = new Padding(4, 5, 4, 5);
        pnlLog.Name = "pnlLog";
        pnlLog.Padding = new Padding(7, 8, 7, 8);
        pnlLog.Size = new Size(1429, 233);
        pnlLog.TabIndex = 2;
        // 
        // txtLog
        // 
        ...
        txtLog.Location = new Point(7, 41);
        txtLog.Margin = new Padding(4, 5, 4, 5);
        txtLog.Multiline = true;
        txtLog.Name = "txtLog";
        txtLog.ReadOnly = true;
        txtLog.ScrollBars = ScrollBars.Vertical;
        txtLog.Size = new Size(1415, 184);
        txtLog.TabIndex = 0;
        // 
        // lblLogTitle
        // 
        ...
        lblLogTitle.Location = new Point(7, 8);
        lblLogTitle.Margin = new Padding(4, 0, 4, 0);
        lblLogTitle.Name = "lblLogTitle";
        lblLogTitle.Size = new Size(1415, 33);
