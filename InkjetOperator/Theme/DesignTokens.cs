...
{
    // ขนาดฟอนต์และความสูงของ control ถูกขยาย 25% พร้อมกับ .Designer.cs ทุกหน้า
    // ให้เหมาะกับ Panel PC จอ Full HD ที่มองจากระยะห่าง — ตัวเลข "จำนวนการใช้งาน"
    // ในคอมเมนต์ด้านล่างนับไว้ก่อนขยาย ใช้ดูสัดส่วนได้ แต่ค่าที่เขียนคือค่าปัจจุบัน
